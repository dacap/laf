...
{
  int required_size =
    ::WideCharToMultiByte(CP_UTF8, 0, src, (int)n, NULL, 0, NULL, NULL);
  ...
  ::WideCharToMultiByte(
    CP_UTF8, 0, src, (int)n, &buf[0], required_size, NULL, NULL);
...
{
  int required_size =
    MultiByteToWideChar(CP_UTF8, 0, src.c_str(), (int)src.size(), NULL, 0);
  ...
  ::MultiByteToWideChar(
    CP_UTF8, 0, src.c_str(), (int)src.size(), &buf[0], required_size);
