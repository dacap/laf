...
TEST(Base64, Encode)
{
  ...
  EXPECT_EQ("5pel5pys6Kqe",
            encode_base64("\xE6\x97\xA5\xE6\x9C\xAC\xE8\xAA\x9E"));  // "日本語"
}
...
TEST(Base64, Decode)
{
  ...
  EXPECT_EQ("\xE6\x97\xA5\xE6\x9C\xAC\xE8\xAA\x9E",
            decode_base64s("5pel5pys6Kqe"));  // "日本語"
}
