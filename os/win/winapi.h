...
typedef BOOL(WINAPI* GetPointerInfo_Func)(UINT32 pointerId,
                                          POINTER_INFO* pointerInfo);
typedef BOOL(WINAPI* GetPointerPenInfo_Func)(UINT32 pointerId,
                                             POINTER_PEN_INFO* penInfo);

typedef HRESULT(WINAPI* CreateInteractionContext_Func)(
  HINTERACTIONCONTEXT* interactionContext);
typedef HRESULT(WINAPI* DestroyInteractionContext_Func)(
  HINTERACTIONCONTEXT interactionContext);
typedef HRESULT(WINAPI* StopInteractionContext_Func)(
  HINTERACTIONCONTEXT interactionContext);
...
typedef HRESULT(WINAPI* AddPointerInteractionContext_Func)(
  HINTERACTIONCONTEXT interactionContext, UINT32 pointerId);
...
typedef BOOL(WINAPI* SetProcessDpiAwarenessContext_Func)(
...
public:
  ...
  RegisterOutputCallbackInteractionContext_Func
  ...
  RemovePointerInteractionContext_Func RemovePointerInteractionContext =
    nullptr;
  SetInteractionConfigurationInteractionContext_Func
  ...
  ProcessPointerFramesInteractionContext_Func
