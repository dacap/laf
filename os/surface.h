...
public:
  ...
  virtual void drawLine(
    float x0, float y0, float x1, float y1, const os::Paint& paint) = 0;

  void drawLine(const int x0,
                const int y0,
                const int x1,
                const int y1,
  ...
  void drawLine(const gfx::PointF& a,
                const gfx::PointF& b,
                const os::Paint& paint)
  {
  ...
  void drawLine(const gfx::Point& a,
                const gfx::Point& b,
                const os::Paint& paint)
  {
    drawLine(float(a.x), float(a.y), float(b.x), float(b.y), paint);
  ...
  {
    drawRect(gfx::RectF(float(rc.x), float(rc.y), float(rc.w), float(rc.h)),
             paint);
  }

  virtual void drawCircle(float cx,
                          float cy,
                          float radius,
  ...
  virtual void blitTo(Surface* dest,
                      int srcx,
                      int srcy,
                      int dstx,
                      int dsty,
