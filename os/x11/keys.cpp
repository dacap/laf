...
KeyScancode x11_keysym_to_scancode(const KeySym keysym)
{
  switch (keysym) {
    ...
    case XK_KP_0:
    case XK_KP_Insert:    return kKey0Pad;
    case XK_KP_1:
    case XK_KP_End:       return kKey1Pad;
    case XK_KP_2:
    case XK_KP_Down:      return kKey2Pad;
    case XK_KP_3:
    case XK_KP_Page_Down: return kKey3Pad;
    case XK_KP_4:
    case XK_KP_Left:      return kKey4Pad;
    case XK_KP_5:
    case XK_KP_Begin:     return kKey5Pad;
    case XK_KP_6:
    case XK_KP_Right:     return kKey6Pad;
    case XK_KP_7:
    case XK_KP_Home:      return kKey7Pad;
    case XK_KP_8:
    case XK_KP_Up:        return kKey8Pad;
    case XK_KP_9:
    case XK_KP_Page_Up:   return kKey9Pad;
    case XK_KP_Decimal:
...
int x11_get_unicode_from_scancode(const KeyScancode scancode)
{
  switch (scancode) {
    ...
    case kKey0:
    case kKey0Pad:       return '0';
    case kKey1:
    case kKey1Pad:       return '1';
    case kKey2:
    case kKey2Pad:       return '2';
    case kKey3:
    case kKey3Pad:       return '3';
    case kKey4:
    case kKey4Pad:       return '4';
    case kKey5:
    case kKey5Pad:       return '5';
    case kKey6:
    case kKey6Pad:       return '6';
    case kKey7:
    case kKey7Pad:       return '7';
    case kKey8:
    case kKey8Pad:       return '8';
    case kKey9:
    case kKey9Pad:       return '9';
    case kKeyColon:      return ':';
    case kKeyBackslash:
    case kKeyBackslash2: return '\\';
