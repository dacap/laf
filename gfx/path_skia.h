...
public:
  ...
  bool isEmpty() const { return m_skPath.isEmpty(); }
  ...
  {
    m_skPath.addRoundRect(
      SkRect::MakeXYWH(rc.x + 0.5, rc.y + 0.5, rc.w, rc.h), rx, ry);
    return *this;
  }
  ...
  void offset(float dx, float dy) { m_skPath.offset(dx, dy); }
